...
### Added
- Added spec §2 principle taxonomy: P2/P3 declared definitional (no runtime obligation) vs 14 behavioral principles — pre-release decision M3, option (c); mirrored in both principle files and orchestrator.
- Added spec §3.9 + integrate.md rationale: /gse:integrate stays standalone (replay, --dry-run, --axis) — pre-release decision M6, documented status quo.
