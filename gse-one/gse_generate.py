...
# Body of the launcher dropped into a project's .gse-sandbox/run by the
# installer. Generic: reads .gse-sandbox/launch.env (platform, mode) sitting
...
def build_launcher() -> None:
    ...
    project's .gse-sandbox/run by the installer (for --mode sandbox / local)."""
    content = (
        "#!/bin/sh\n"
